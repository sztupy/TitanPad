 ...
 */
#define LOG_TAG "TitanPadNativeDevice"
...
// Send event over the fd.
    ...
    static JNINativeMethod sMethods[] = {
            {"nativeOpenDevice",
                                                ...
                                                "Lscot/raven/titanpad/core/control/Device$DeviceCallback;)J",
    ...
    int register_scot_raven_titanpad_core_control_Device(JNIEnv* env) {
        jclass clazz = env->FindClass("scot/raven/titanpad/core/control/Device$DeviceCallback");
        if (clazz == NULL) {
        ...
        return jniRegisterNativeMethods(env, "scot/raven/titanpad/core/control/Device",
...
jint JNI_OnLoad(JavaVM* jvm, void*) {
    ...
    if (android::register_scot_raven_titanpad_core_control_Device(env) < 0 ){
        return JNI_ERR;
    }
